...
- (IBAction)install:(id)sender
{
	...
	if ([openPanel runModalForDirectory:@"/Applications/" file:@"Seashore.app" types:[NSArray arrayWithObject:@"app"]] == NSOKButton) {
		...
		if (success) {
			...
			success = success && [fileManager copyPath:[[[NSBundle mainBundle] resourcePath] stringByAppendingString:@"/SVGImporter.app"] toPath:[destPath stringByAppendingString:@"/Contents/PlugIns/SVGImporter.app"] handler:NULL];
		}
		if (!success) {
