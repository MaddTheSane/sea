...
/*!
	@method		initWithIdentifier:label:imageNamed:toolTip:target:selector:
...
*/
-(instancetype)initWithItemIdentifier:(NSToolbarItemIdentifier)itemIdent label:(NSString *)label imageNamed:(NSImageName)image toolTip:(NSString *)toolTip target:(id)target selector:(SEL)selector;
...
/*!
	...
	@param		label
				The label of the item for both the regular view and menu view.
	@param		image
				The image that represents the item.
	@param		toolTip
				The tooltip for the item.
	@param		target
				The target of the toolbar item.
	...
	@result		Returns instance upon success.
*/
-(instancetype)initWithItemIdentifier:(NSToolbarItemIdentifier)itemIdent label:(NSString *)label image:(NSImage *)image toolTip:(NSString *)toolTip target:(id)target selector:(SEL)selector;
