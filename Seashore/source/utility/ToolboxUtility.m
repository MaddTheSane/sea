...
- (NSToolbarItem *) toolbar: (NSToolbar *)toolbar itemForItemIdentifier: (NSString *) itemIdent willBeInsertedIntoToolbar:(BOOL) willBeInserted
{
    ...
    if ([itemIdent isEqual: SelectionIdentifier]) {
        ...
        return [[ImageToolbarItem alloc] initWithItemIdentifier: NewLayerToolbarItemIdentifier label: LOCALSTR(@"new", @"New") imageNamed: @"new-tb" toolTip: LOCALSTR(@"new tooltip", @"Add a new layer to the image") target: [[SeaController utilitiesManager] pegasusUtilityFor:document] selector: @selector(addLayer:)];
	} else if ([itemIdent isEqual: DuplicateLayerToolbarItemIdentifier]) {
		return [[ImageToolbarItem alloc] initWithItemIdentifier: DuplicateLayerToolbarItemIdentifier label: LOCALSTR(@"duplicate", @"Duplicate") imageNamed: @"duplicate-tb" toolTip: LOCALSTR(@"duplicate tooltip", @"Duplicate the current layer") target: [[SeaController utilitiesManager] pegasusUtilityFor:document]  selector: @selector(duplicateLayer:)];
	} else if ([itemIdent isEqual: ForwardToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: ForwardToolbarItemIdentifier label: LOCALSTR(@"forward", @"Forward") imageNamed: @"forward-tb" toolTip: LOCALSTR(@"forward tooltip", @"Move the current layer forward") target: [[SeaController utilitiesManager] pegasusUtilityFor:document]  selector: @selector(forward:)];
        ...
        return [[ImageToolbarItem alloc] initWithItemIdentifier: ZoomOutToolbarItemIdentifier label: LOCALSTR(@"zoom out", @"Zoom Out") imageNamed: @"zoomOut" toolTip: LOCALSTR(@"zoom out tooltip", @"Zoom out from the current view") target: [document docView] selector: @selector(zoomOut:)];
	} else if ([itemIdent isEqual: ActualSizeToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: ActualSizeToolbarItemIdentifier label: LOCALSTR(@"actual size", @"Actual Size") imageNamed: @"actualSize" toolTip: LOCALSTR(@"actual size tooltip", @"View the document at its actual size") target: [document docView] selector: @selector(zoomNormal:)];
	} else if ([itemIdent isEqual: ToggleLayersToolbarItemIdentifier]) {
		return [[ImageToolbarItem alloc] initWithItemIdentifier: ToggleLayersToolbarItemIdentifier label: LOCALSTR(@"toggle layers", @"Layers") imageNamed: @"showhidelayers" toolTip: LOCALSTR(@"toggle layers tooltip", @"Show or hide the layers list view") target: [[SeaController utilitiesManager] pegasusUtilityFor:document] selector: @selector(toggleLayers:)];
	} else if ([itemIdent isEqual: InspectorToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: InspectorToolbarItemIdentifier label: LOCALSTR(@"information", @"Information") imageNamed: @"inspector" toolTip: LOCALSTR(@"information tooltip", @"Show or hide point information") target: [[SeaController utilitiesManager] infoUtilityFor:document]  selector: @selector(toggle:)];
	} else if ([itemIdent isEqual: FloatAnchorToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: FloatAnchorToolbarItemIdentifier label: LOCALSTR(@"float", @"Float") imageNamed: @"float-tb" toolTip: LOCALSTR(@"float tooltip", @"Float or anchor the current selection") target: [document contents] selector: @selector(toggleFloatingSelection:)];
	} else if ([itemIdent isEqual: DuplicateSelectionToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: DuplicateSelectionToolbarItemIdentifier label: LOCALSTR(@"duplicate", @"Duplicate") imageNamed: @"duplicatesel-tb" toolTip: LOCALSTR(@"duplicate tooltip", @"Duplicate the current selection") target: [document contents] selector: @selector(duplicate:)];
	} else if ([itemIdent isEqual: SelectNoneToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: SelectNoneToolbarItemIdentifier label: LOCALSTR(@"select none", @"None") imageNamed: @"none-tb" toolTip: LOCALSTR(@"select none tooltip", @"Select nothing") target: [document docView]  selector: @selector(selectNone:)];
	} else if ([itemIdent isEqual: SelectAllToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: SelectAllToolbarItemIdentifier label: LOCALSTR(@"select all", @"All") imageNamed: @"selectall" toolTip: LOCALSTR(@"select All tooltip", @"Select all of the current layer") target: [document docView]  selector: @selector(selectAll:)];
	} else if ([itemIdent isEqual: SelectInverseToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: SelectInverseToolbarItemIdentifier label: LOCALSTR(@"select none", @"Inverse") imageNamed: @"selectinverse" toolTip: LOCALSTR(@"select inverse tooltip", @"Select the inverse of the current selection") target: [document docView]  selector: @selector(selectInverse:)];
	} else if ([itemIdent isEqual: SelectAlphaToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: SelectAlphaToolbarItemIdentifier label: LOCALSTR(@"select alpha", @"Alpha") imageNamed: @"selectalpha" toolTip: LOCALSTR(@"select alpha tooltip", @"Select a copy of the alpha transparency channel") target: [document docView]  selector: @selector(selectOpaque:)];
    }
