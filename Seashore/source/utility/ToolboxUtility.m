...
- (NSToolbarItem *) toolbar: (NSToolbar *)toolbar itemForItemIdentifier: (NSString *) itemIdent willBeInsertedIntoToolbar:(BOOL) willBeInserted
{
    ...
    if ([itemIdent isEqual: SelectionIdentifier]) {
        ...
        return [[ImageToolbarItem alloc] initWithItemIdentifier: NewLayerToolbarItemIdentifier label: LOCALSTR(@"new", @"New") image: @"new-tb" toolTip: LOCALSTR(@"new tooltip", @"Add a new layer to the image") target: [[SeaController utilitiesManager] pegasusUtilityFor:document] selector: @selector(addLayer:)];
        ...
        return [[ImageToolbarItem alloc] initWithItemIdentifier: ForwardToolbarItemIdentifier label: LOCALSTR(@"forward", @"Forward") image: @"forward-tb" toolTip: LOCALSTR(@"forward tooltip", @"Move the current layer forward") target: [[SeaController utilitiesManager] pegasusUtilityFor:document]  selector: @selector(forward:)];
	} else if ([itemIdent isEqual: BackwardToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: BackwardToolbarItemIdentifier label: LOCALSTR(@"backward", @"Backward") image: @"backward-tb" toolTip: LOCALSTR(@"backward tooltip", @"Move the current layer backward") target: [[SeaController utilitiesManager] pegasusUtilityFor:document]  selector: @selector(backward:)];
	} else if ([itemIdent isEqual: DeleteLayerToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: DeleteLayerToolbarItemIdentifier label: LOCALSTR(@"delete", @"Delete") image: @"delete-tb" toolTip: LOCALSTR(@"delete tooltip", @"Delete the current layer") target: [[SeaController utilitiesManager] pegasusUtilityFor:document]  selector: @selector(deleteLayer:)];
	} else if ([itemIdent isEqual: ZoomInToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: ZoomInToolbarItemIdentifier label: LOCALSTR(@"zoom in", @"Zoom In") image: @"zoomIn" toolTip: LOCALSTR(@"zoom in tooltip", @"Zoom in on the current view") target: [document docView] selector: @selector(zoomIn:)];
	} else if ([itemIdent isEqual: ZoomOutToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: ZoomOutToolbarItemIdentifier label: LOCALSTR(@"zoom out", @"Zoom Out") image: @"zoomOut" toolTip: LOCALSTR(@"zoom out tooltip", @"Zoom out from the current view") target: [document docView] selector: @selector(zoomOut:)];
	} else if ([itemIdent isEqual: ActualSizeToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: ActualSizeToolbarItemIdentifier label: LOCALSTR(@"actual size", @"Actual Size") image: @"actualSize" toolTip: LOCALSTR(@"actual size tooltip", @"View the document at its actual size") target: [document docView] selector: @selector(zoomNormal:)];
        ...
        return [[ImageToolbarItem alloc] initWithItemIdentifier: SelectNoneToolbarItemIdentifier label: LOCALSTR(@"select none", @"None") image: @"none-tb" toolTip: LOCALSTR(@"select none tooltip", @"Select nothing") target: [document docView]  selector: @selector(selectNone:)];
	} else if ([itemIdent isEqual: SelectAllToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: SelectAllToolbarItemIdentifier label: LOCALSTR(@"select all", @"All") image: @"selectall" toolTip: LOCALSTR(@"select All tooltip", @"Select all of the current layer") target: [document docView]  selector: @selector(selectAll:)];
	} else if ([itemIdent isEqual: SelectInverseToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: SelectInverseToolbarItemIdentifier label: LOCALSTR(@"select none", @"Inverse") image: @"selectinverse" toolTip: LOCALSTR(@"select inverse tooltip", @"Select the inverse of the current selection") target: [document docView]  selector: @selector(selectInverse:)];
	} else if ([itemIdent isEqual: SelectAlphaToolbarItemIdentifier]) {
        return [[ImageToolbarItem alloc] initWithItemIdentifier: SelectAlphaToolbarItemIdentifier label: LOCALSTR(@"select alpha", @"Alpha") image: @"selectalpha" toolTip: LOCALSTR(@"select alpha tooltip", @"Select a copy of the alpha transparency channel") target: [document docView]  selector: @selector(selectOpaque:)];
    }
