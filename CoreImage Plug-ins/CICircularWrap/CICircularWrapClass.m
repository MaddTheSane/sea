...
- (void)run
{
	...
	self.angle = 0.0;
	if (bounds.size.width < PI * radius) self.angle = PI / 2.0 + bounds.size.width / (2.0 * radius);
	else if (bounds.size.width < 2.0 * PI * radius) self.angle = (- 3 * PI + bounds.size.width / radius) / 2.0;
