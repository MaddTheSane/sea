...
- (unsigned char *)executeChannel:(PluginData *)pluginData withBitmap:(unsigned char *)data
{
	...
	// Run CoreImage effect
	resdata = [self monochrome:pluginData withBitmap:datatouse];
...
- (unsigned char *)monochrome:(PluginData *)pluginData withBitmap:(unsigned char *)data
{
	CIContext *context;
	...
	height = [pluginData height];
	selection = [pluginData selection];
	mainColor = [CIColor colorWithRed:[mainNSColor redComponent] green:[mainNSColor greenComponent] blue:[mainNSColor blueComponent]];
