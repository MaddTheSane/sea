...
static QLPlugType   *AllocQuickLookGeneratorPluginType(CFUUIDRef inFactoryID);
static void          DeallocQuickLookGeneratorPluginType(QLPlugType *thisInstance);
...
//
QLPlugType *AllocQuickLookGeneratorPluginType(CFUUIDRef inFactoryID)
{
    QLPlugType *theNewInstance = (QLPlugType *)calloc(sizeof(QLPlugType), 1);
...
//
void DeallocQuickLookGeneratorPluginType(QLPlugType *thisInstance)
{
...
HRESULT QuickLookGeneratorQueryInterface(void *thisInstance,REFIID iid,LPVOID *ppv)
{
    ...
    if (CFEqual(interfaceID, kQLGeneratorCallbacksInterfaceID)) {
         ...
         * return good status.
         */
        ((QLGeneratorInterfaceStruct *)((QLPlugType *)thisInstance)->conduitInterface)->GenerateThumbnailForURL = GenerateThumbnailForURL;
        ((QLGeneratorInterfaceStruct *)((QLPlugType *)thisInstance)->conduitInterface)->CancelThumbnailGeneration = CancelThumbnailGeneration;
        ((QLGeneratorInterfaceStruct *)((QLPlugType *)thisInstance)->conduitInterface)->GeneratePreviewForURL = GeneratePreviewForURL;
        ((QLGeneratorInterfaceStruct *)((QLPlugType *)thisInstance)->conduitInterface)->CancelPreviewGeneration = CancelPreviewGeneration;
        ((QLGeneratorInterfaceStruct *)((QLPlugType*)thisInstance)->conduitInterface)->AddRef(thisInstance);
        *ppv = thisInstance;
...
{
    return ++((QLPlugType *)thisInstance )->refCount;
}
...
{
    ((QLPlugType*)thisInstance)->refCount -= 1;
    if (((QLPlugType*)thisInstance)->refCount == 0){
        DeallocQuickLookGeneratorPluginType((QLPlugType*)thisInstance );
        return 0;
    }else{
        return ((QLPlugType*) thisInstance )->refCount;
    }
